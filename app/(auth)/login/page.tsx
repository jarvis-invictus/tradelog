  ...
  return (
    <div className="w-full">
      ...
      <div className="lg:hidden text-center mb-8">
        <div className="w-10 h-10 rounded-[12px] bg-accent flex items-center justify-center mx-auto mb-4">
      ...
      <div className="bg-ink-surface border border-ink-border rounded-2xl p-6 lg:p-8">
